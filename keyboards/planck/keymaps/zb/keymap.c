...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [4] = LAYOUT_ortho_4x12(KC_GRV, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_BSPC, KC_POWER, KC_VOLU, KC_MPLY, KC_MRWD, KC_BRIU, KC_NO, KC_NO, KC_NO, KC_NO, KC_MINS, KC_EQL, KC_BSLS, KC_LSFT, KC_VOLD, KC_MUTE, KC_MFFD, KC_BRID, KC_NO, KC_NO, KC_NO, KC_NO, KC_LBRC, KC_RBRC, KC_ENT, MO(5), KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT),
