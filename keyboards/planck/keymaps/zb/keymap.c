...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_ortho_4x12(KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F4, KC_NO, KC_NO, KC_NO, KC_P7, KC_P8, KC_P9, KC_PSLS, KC_TRNS, KC_F5, KC_F6, KC_F7, KC_F8, KC_NO, KC_HOME, KC_PGUP, KC_P4, KC_P5, KC_P6, KC_PAST, KC_LSFT, KC_F9, KC_F10, KC_F11, KC_F12, KC_NO, KC_END, KC_PGDN, KC_P1, KC_P2, KC_P3, KC_PMNS, MO(3), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_PDOT, KC_P0, KC_PEQL, KC_PPLS),
	...
	[4] = LAYOUT_ortho_4x12(KC_GRV, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_DEL, KC_POWER, KC_VOLU, KC_MPLY, KC_MRWD, KC_BRIU, KC_NO, KC_NO, KC_NO, KC_NO, KC_MINS, KC_EQL, KC_BSLS, KC_LSFT, KC_VOLD, KC_MUTE, KC_MFFD, KC_BRID, KC_NO, KC_NO, KC_NO, KC_NO, KC_LBRC, KC_RBRC, KC_ENT, MO(5), KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT),
	[5] = LAYOUT_ortho_4x12(KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL, KC_TRNS, RGB_HUI, RGB_TOG, RGB_SPI, RGB_VAI, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_CAPS, RGB_HUD, RGB_MOD, RGB_SPD, RGB_VAD, KC_NO, KC_NO, KC_NO, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_NO, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS)
};
